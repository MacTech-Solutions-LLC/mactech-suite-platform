...
export async function POST(request: NextRequest) {
  ...
  const parsed = createSuiteObjectReferenceSchema.safeParse(body);
  if (!parsed.success) {
  ...
  try {
    const reference = await createSuiteObjectReference(
      {
        ...input,
