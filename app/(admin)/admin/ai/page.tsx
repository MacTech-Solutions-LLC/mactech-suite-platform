...
export default async function MacTechAiPage() {
  ...
  return <div className="space-y-6"><PageHeader title="MacTech AI" description="Tenant-aware Suite intelligence with approved retrieval, controlled tools, and human-gated actions." /><AiWorkspace organizations={organizations} canAdmin={ctx.permissions.includes(PLATFORM_PERMISSIONS.AI_ADMIN)} initialConversationId={randomUUID()} /></div>;
}
