...
const APP_FIXTURES = [
  ...
  },
  {
    appKey: "mactech-ai",
    name: "MacTech AI",
    description: "Tenant-aware Suite intelligence gateway with approved retrieval, controlled tools, and human-gated actions.",
    category: "other" as const,
    baseUrl: "https://www.suite.mactechsolutionsllc.com/admin/ai",
    requiresOrgContext: true,
    isInternalOnly: false,
    status: "active" as const,
    adminUrl: "https://www.suite.mactechsolutionsllc.com/admin/ai/admin",
    criticality: "high" as const,
    lifecycle: "development" as const,
    visibility: "customer" as const,
    repoFullName: "MacTech-Solutions-LLC/mactech-suite-platform",
