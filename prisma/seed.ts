...
const APP_FIXTURES = [
  ...
  },
  {
    appKey: "finance",
    name: "Finance",
    description: "BOE, rate cards, indirect rates, commercial pricing, invoice generation, labor actuals reconciliation, and QuickBooks handoff via Hub OAuth proxy. Formerly appKey: pricing.",
    category: "reporting" as const,
    requiresOrgContext: true,
    isInternalOnly: false,
    status: "development" as const,
  ...
  // Legacy alias — retained as a hidden deprecated row for DB compatibility.
  // Remove after every dependency edge and satellite reference migrates to "finance".
  {
    appKey: "pricing",
    name: "Finance (legacy alias: pricing)",
    description: "Legacy appKey alias for Finance. Hidden deprecated registry row — do not use in new code.",
    category: "reporting" as const,
    requiresOrgContext: true,
    isInternalOnly: false,
    status: "hidden" as const,
  ...
  },
  {
    appKey: "bizops",
    name: "BizOps",
    description: "Commercial Suite company profile, team roster, and campaign operations.",
    category: "other" as const,
    requiresOrgContext: true,
    isInternalOnly: false,
    status: "development" as const,
...
const APP_DEPENDENCIES: Array<{
  ...
  { sourceAppKey: "governance", targetAppKey: "finance", dependencyType: "governance_source", description: "Rate cards, clause risk, FRCS scope boundaries, and approval metadata feed Finance", criticality: "high" },
  { sourceAppKey: "finance", targetAppKey: "proposal", dependencyType: "api_calls", description: "Approved price volume, BOE summary, Green Team metadata, and FRCS scope export feed ProposalOS", criticality: "high" },
