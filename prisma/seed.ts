...
const APP_FIXTURES = [
  ...
  },
  {
    appKey: "finance",
    name: "Finance",
    description: "BOE, rate cards, indirect rates, proposed price, DCAA-ready timekeeping, charge codes, labor distribution, payroll reconciliation, invoice generation, financial actuals, and QuickBooks handoff via Hub OAuth proxy.",
    category: "reporting" as const,
    requiresOrgContext: true,
    isInternalOnly: false,
    status: "active" as const,
